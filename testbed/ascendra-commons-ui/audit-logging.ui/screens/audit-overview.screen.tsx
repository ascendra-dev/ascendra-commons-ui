...
import type { AuditStats } from '../api/audit-api.types';

export interface AuditOverviewScreenProps {
  fetchStats?: (window?: string) => Promise<AuditStats>;
}
...
/** The module's landing page — audit-logging.ui's one nav.ts entry points here. */
export function AuditOverviewScreen({ fetchStats = (w) => auditApi.stats(w) }: AuditOverviewScreenProps) {
