...
import { auditEventColumns, auditQueryDefs, auditQueryFunctions } from '@/ascendra-commons-ui/audit-logging.ui/queries';
import { auditLogLinks } from '@/ascendra-commons-ui/audit-logging.ui/links';
import type { AuditEvent, AuditQuery } from '@/ascendra-commons-ui/audit-logging.ui/api';

/**
 * The two fetchers this page calls — real API by default. A consumer
 * without a live backend (e.g. testbed) swaps these for mocks from
 * `audit-logging.ui/mocks` instead of editing the page body.
 */
const queryFunctions = auditQueryFunctions;
const downloadCsv = (query: Omit<AuditQuery, 'limit' | 'cursor'>) => auditApi.downloadEventsCsv(query);
